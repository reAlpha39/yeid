...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="header-text">You have a revised SPK Record waiting for your approval.</div>
        </div>

        <div class="content">
            <div class="greeting">
                Halo <strong>{{ $approver->name }}</strong>,<br><br>
                Anda diminta untuk menyetujui sebuah permintaan yang telah di revisi. Berikut adalah informasi
                singkatnya.
            </div>
